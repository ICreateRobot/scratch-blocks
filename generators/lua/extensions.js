...
//bricks
Blockly.Lua['bricksmotor_motoranagle']=function(block){
    // alert(JSON.stringify(block))
	// Blockly.Lua.definitions_['from PIL import Image'] = "from PIL import Image";
...
Blockly.Lua['brickssensors_colorSensor']=function(block){
    let ONE = block.getFieldValue('ONE');
    let TWO = block.getFieldValue('TWO');
...
Blockly.Lua['brickssensors_colorRgb']=function(block){
    let ONE = block.getFieldValue('ONE');
    let TWO = block.getFieldValue('TWO');
...
Blockly.Lua['brickssensors_colorLight']=function(block){
    let ONE = block.getFieldValue('ONE');
...
Blockly.Lua['brickssensors_touch']=function(block){
    let ONE = block.getFieldValue('ONE');
...
Blockly.Lua['event_when']=function(block){
