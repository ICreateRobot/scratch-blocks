...
Blockly.Python['robotimg_isOpenModel']=function(block){

    let code='icrobot.ai.ai_flag()'
...
Blockly.Python['robotsensors_moveClearDistance']=function(block){


    let code = `icrobot.motor.clear_distance()\n`
...
Blockly.Python['robotactuator_gripperOpen']=function(block){
    ...
    // Blockly.Python.definitions_['icrobot'] = "import icrobot";
    let port= block.getFieldValue('ONE') || 'False';
    let state=block.getFieldValue('TWO') || 'False';

    let code
    if(state=='0'){
        code = `icrobot.gripper.open(${port})\n`
    }else if(state=='1'){
        code = `icrobot.gripper.close(${port})\n`
    }
...
Blockly.Python['robotactuator_gripperOpenUntil']=function(block){
    ...
    if(state=='0'){
        code = `icrobot.gripper.open_until_done(${port})\n`
    }else if(state=='1'){
        code = `icrobot.gripper.close_until_done(${port})\n`
    }
...
Blockly.Python['robotactuator_motor']=function(block){
...
Blockly.Python['robotshow_showTextNoPlace']=function(block){
    ...
    let targetBlock = block.getInputTargetBlock('ONE');
    console.log(targetBlock.type)
    if(!text.startsWith('icrobot') && targetBlock.type=='text' && text.length>30){
        console.log('分割')
        text=`${text.slice(0,30)}'`
    }
    let code=`icrobot.display.show_text(str(${text}))\n`
...
Blockly.Python['robotshow_taillight']=function(block){
    let text= Blockly.Python.valueToCode(block, 'ONE',Blockly.Python.ORDER_NONE) || Blockly.Python.statementToCode(block,'ONE');
    // let mode= block.getFieldValue('TWO') || 'False';
    // text=text.replace(/^["']|["']$/g, '');

    let rgb=hexToRgb(text)
    let code=`icrobot.taillight.rgb(${rgb[0]},${rgb[1]},${rgb[2]})\n`
...
Blockly.Python['robotshow_taillightrgb']=function(block){
    let r= Blockly.Python.valueToCode(block, 'ONE',Blockly.Python.ORDER_NONE) || Blockly.Python.statementToCode(block,'ONE');
    let g= Blockly.Python.valueToCode(block, 'TWO',Blockly.Python.ORDER_NONE) || Blockly.Python.statementToCode(block,'TWO');
    let b= Blockly.Python.valueToCode(block, 'THREE',Blockly.Python.ORDER_NONE) || Blockly.Python.statementToCode(block,'THREE');
    // let mode= block.getFieldValue('TWO') || 'False';
    // text=text.replace(/^["']|["']$/g, '');

    // let rgb=hexToRgb(text)
    let code=`icrobot.taillight.rgb(${Number(r)},${Number(g)},${Number(b)})\n`
...
Blockly.Python['robotshow_setPixelSave']=function(block){
    ...
    code=`icrobot.display.add_pixel(int(${x}),int(${y}))\n`
    // if(state=='0'){
...
Blockly.Python['robotshow_setPixel']=function(block){
    ...
    code=`icrobot.display.set_pixel(int(${x}),int(${y}))\n`
    // if(state=='0'){
    //     code=`icrobot.display.set_pixel(${x},${y},True)\n`
    // }else if(state=='1'){
    //     code=`icrobot.display.set_pixel(${x},${y},False)\n`
...
Blockly.Python['robotshow_clearPixel']=function(block){
    ...
    code=`icrobot.display.clear_pixel(int(${x}),int(${y}))\n`
    // if(state=='0'){
    //     code=`icrobot.display.set_pixel(${x},${y},True)\n`
    // }else if(state=='1'){
    //     code=`icrobot.display.set_pixel(${x},${y},False)\n`
...
Blockly.Python['robotshow_changePixel']=function(block){
    ...
    code=`icrobot.display.toggle_pixel(int(${x}),int(${y}))\n`
    // if(state=='0'){
    //     code=`icrobot.display.set_pixel(${x},${y},True)\n`
    // }else if(state=='1'){
    //     code=`icrobot.display.set_pixel(${x},${y},False)\n`
...
Blockly.Python['robotsensors_lineportcolor']=function(block){

    // Blockly.Python.definitions_['icrobot'] = "import icrobot";
    let port= block.getFieldValue('ONE') || 'False';
    let color= block.getFieldValue('TWO') || 'False';
    let code=`icrobot.rgb_sensor.read_line_value(${port})==${color}`
...
Blockly.Python['robotsensors_startLineUntil']=function(block){
    ...
    let speed= block.getFieldValue('TWO') || 'False';
    let lineData=Blockly.Python.statementToCode(block,'ONE');

    speed=speed.replace(/^["']|["']$/g, '');

    lineData=lineData.trimStart()
    console.log(lineData)
    console.log(typeof lineData)


    const arr = lineData.toString().split('').map(Number);
    let code
...
Blockly.Python['robotsensors_startLine']=function(block){
    ...
    let speed= block.getFieldValue('ONE') || 'False';
...
Blockly.Python['robotsensors_startPreDown']=function(block){
    ...
    speed=speed.replace(/^["']|["']$/g, '');
    let code
    code=`icrobot.rgb_sensor.anti_fall(${speed})\n`
...
Blockly.Python['robotsensors_stopPreDown']=function(block){
    

    let code
    code=`icrobot.rgb_sensor.stop_anti_fall()\n`
...
Blockly.Python['robotimg_cstartMode']=function(block){
    ...
    if(mode=='1'){
        ...
        code=`icrobot.ai.set_model(icrobot.ai.apriltag_recognition)\n`
        // code=`icrobot.ai.set_model( ai.roadsign_recognition)\n`
    }else if(mode=='10'){
        code=`icrobot.ai.set_model(icrobot.ai.cat_detection)\n`
    }
...
Blockly.Python['robotcolorxy_cstartMode']=function(block){
...
Blockly.Python['robotqr_cstartMode']=function(block){
...
Blockly.Python['robotface_cstartMode']=function(block){
...
Blockly.Python['robotapriltag_cstartMode']=function(block){
...
Blockly.Python['robotcat_cstartMode']=function(block){
...
Blockly.Python['robotcolorxy_cstopMode']=function(block){
...
Blockly.Python['robotqr_cstopMode']=function(block){
...
Blockly.Python['robotface_cstopMode']=function(block){
...
Blockly.Python['robotapriltag_cstopMode']=function(block){
...
Blockly.Python['robotcat_cstopMode']=function(block){
...
Blockly.Python['robotapriltag_getAprilContent']=function(block){
    

    let code
    code=`icrobot.ai.get_apriltag_information()`
...
Blockly.Python['robotapriltag_getAprilPlace']=function(block){
    

    let mode=block.getFieldValue('ONE') || 'False';
    let code
    code=`icrobot.ai.get_apriltag_location('${mode}')`
...
Blockly.Python['robotapriltag_getAprilWh']=function(block){
    

    let mode=block.getFieldValue('ONE') || 'False';
    let code
    if(mode=='0'){
        code=`icrobot.ai.get_apriltag_size('width')`
    }else if(mode=='1'){
        code=`icrobot.ai.get_apriltag_size('height')`
    }
...
Blockly.Python['robotapriltag_isApril']=function(block){
    

    let code
    code=`icrobot.ai.apriltag_isrecognized()`
...
Blockly.Python['robotqr_getQrContent']=function(block){
...
Blockly.Python['robotqr_isQr']=function(block){
...
Blockly.Python['robotqr_getQrPlace']=function(block){
...
Blockly.Python['robotcolorxy_setColor']=function(block){
...
Blockly.Python['robotcolorxy_isReadColor']=function(block){
...
Blockly.Python['robotcolorxy_readColorPlace']=function(block){
...
Blockly.Python['robotface_isFace']=function(block){
    let code
...
Blockly.Python['robotface_faceNum']=function(block){
    let code
...
Blockly.Python['robotface_facePlace']=function(block){
    let place=block.getFieldValue('ONE') || 'False';
    let code
...
Blockly.Python['robotcat_isCat']=function(block){
    let code
    code=`icrobot.ai.cat_isdetected()`
...
Blockly.Python['robotcat_catNum']=function(block){
    let code
    code=`icrobot.ai.get_cat_number()`
...
Blockly.Python['robotcat_catPlace']=function(block){
    let place=block.getFieldValue('ONE') || 'False';
    let code
    code=`icrobot.ai.get_cat_location('${place}')`
...
function getAllNextBlocks(block) {
    const blocks = [];
    let current = block.nextConnection && block.nextConnection.targetBlock();
    while (current) {
        blocks.push(current);
...
function generateUnindentedCodeForChildren(block) {
    const childBlocks = getAllNextBlocks(block);
    let code = '';
    for (const child of childBlocks) {
        let line = Blockly.Python.blockToCode(child);
        // 如果 blockToCode 返回数组（表达式块），取第一个
        if (Array.isArray(line)) line = line[0];
        // 取消行首的缩进（假设是四个空格）
        line = line.replace(/^ {4}/gm, ''); 
        code += line;
    }
    return code;
}
